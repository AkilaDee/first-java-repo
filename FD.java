public class FD extends BankAccount {

    private final double interest = 8;
    private final String accountType = "FD";

    public FD() {
        System.out.println("You have to provide nesseassry details , in order to create an account.");
    }

    public FD(int accNumber, String accHoldersname, String branch) {
